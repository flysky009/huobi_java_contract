...
public class HuobiLinearSwapAPIConstants {
    ...
    public static final String SWAP_SETTLEMENT_RECORDS="/linear-swap-api/v1/swap_settlement_records";//29.查询平台历史结算记录
    public static final String SWAP_LEVER_POSITION_LIMIT="/linear-swap-api/v1/swap_lever_position_limit";//30.查询用户所有杠杆持仓量限制
    public static final String BATCH_MERGED_V2 = "/v2/linear-swap-ex/market/detail/batch_merged"; // 31.批量获取聚合行情（V2）
    ...
    public static final String SWAP_SUB_AUTH = "/linear-swap-api/v1/swap_sub_auth"; // 17.批量设置子账户交易权限
    ...
    public static final String SWAP_FINANCIAL_RECORD_V3 = "/linear-swap-api/v3/swap_financial_record"; // 22.查询用户财务记录(新)
    public static final String SWAP_FINANCIAL_RECORD_EXACT_V3 = "/linear-swap-api/v3/swap_financial_record_exact"; // 23.组合查询用户财务记录 (新)
    public static final String SWAP_UNIFIED_ACCOUNT_TYPE = "/linear-swap-api/v3/swap_unified_account_type"; // 24.账户类型查询
    public static final String SWAP_SWITCH_ACCOUNT_TYPE = "/linear-swap-api/v3/swap_switch_account_type"; // 25.账户类型更改接口
    public static final String SWAP_LIQUIDATION_ORDERS_V3 = "/linear-swap-api/v3/swap_liquidation_orders"; // 26.获取强平订单(新)
    public static final String SWAP_QUERY_ELEMENTS = "/linear-swap-api/v1/swap_query_elements"; // 27.合约要素
    public static final String UNIFIED_ACCOUNT_INFO = "/linear-swap-api/v3/unified_account_info"; // 28.查询统一账户资产
    public static final String LINEAR_SWAP_OVERVIEW_ACCOUNT_INFO = "/linear-swap-api/v3/linear_swap_overview_account_info"; // 29.可抵扣HT资产查询
    public static final String LINEAR_SWAP_FEE_SWITCH = "/linear-swap-api/v3/linear_swap_fee_switch"; // 30.设置U本位合约手续费抵扣方式
    public static final String FIX_POSITION_MARGIN_CHANGE = "/linear-swap-api/v3/fix_position_margin_change"; // 31.调整逐仓持仓保证金
    public static final String FIX_POSITION_MARGIN_CHANGE_RECORD = "/linear-swap-api/v3/fix_position_margin_change_record"; // 32.查询调整逐仓持仓保证金记录
    public static final String SWAP_SUB_AUTH_LIST = "/linear-swap-api/v1/swap_sub_auth_list"; // 33.【通用】查询子账户交易权限
    ...
    public static final String SWAP_TRIGGER_ORDER = "/linear-swap-api/v1/swap_trigger_order"; //11.计划委托下单
    public static final String SWAP_TRIGGER_CANCEL = "/linear-swap-api/v1/swap_trigger_cancel";//12.计划委托撤单
    public static final String SWAP_TRIGGER_CANCELALL = "/linear-swap-api/v1/swap_trigger_cancelall";//13.计划委托全部撤单
    public static final String SWAP_TRIGGER_OPENORDERS = "/linear-swap-api/v1/swap_trigger_openorders";//14.获取计划委托当前委托
    public static final String SWAP_TRIGGER_HISORDERS = "/linear-swap-api/v1/swap_trigger_hisorders";//15.获取计划委托历史委托
    public static final String SWAP_SWITCH_LEVER_RATE = "/linear-swap-api/v1/swap_switch_lever_rate";// 16.切换杠杆
    public static final String SWAP_TPSL_ORDER = "/linear-swap-api/v1/swap_tpsl_order";//17.对仓位设置止盈止损订单
    public static final String SWAP_TPSL_CANCEL = "/linear-swap-api/v1/swap_tpsl_cancel";//18.止盈止损订单撤单
    public static final String SWAP_TPSL_CANCELALL = "/linear-swap-api/v1/swap_tpsl_cancelall";//19.止盈止损订单全部撤单
    public static final String SWAP_TPSL_OPENORDERS = "/linear-swap-api/v1/swap_tpsl_openorders";//20.查询止盈止损订单当前委托
    public static final String SWAP_TPSL_HISORDERS = "/linear-swap-api/v1/swap_tpsl_hisorders";//21.查询止盈止损订单历史委托
    public static final String SWAP_RELATION_TPSL_ORDER = "/linear-swap-api/v1/swap_relation_tpsl_order";//22.查询开仓单关联的止盈止损订单详情
    public static final String SWAP_MATCHRESULTS_EXACT = "/linear-swap-api/v1/swap_matchresults_exact"; // 23.组合查询用户历史成交记录
    public static final String SWAP_HISORDERS_EXACT = "/linear-swap-api/v1/swap_hisorders_exact"; // 24.组合查询合约历史委托
    public static final String SWAP_TRACK_ORDER = "/linear-swap-api/v1/swap_track_order"; // 25.跟踪委托订单下单

    public static final String SWAP_TRACK_CANCEL= "/linear-swap-api/v1/swap_track_cancel"; // 26.跟踪委托订单撤单
    public static final String SWAP_TRACK_CANCELALL = "/linear-swap-api/v1/swap_track_cancelall"; // 27.跟踪委托订单全部撤单
    public static final String SWAP_TRACK_OPENORDERS = "/linear-swap-api/v1/swap_track_openorders"; // 28.跟踪委托订单当前委托
    public static final String SWAP_TRACK_HISORDERS = "/linear-swap-api/v1/swap_track_hisorders"; // 29.跟踪委托订单历史委托
    public static final String SWAP_SWITCH_POSITION_MODE="/linear-swap-api/v1/swap_switch_position_mode";//30.切换持仓模式
    public static final String LINEAR_CANCEL_AFTER = "/linear-swap-api/v1/linear-cancel-after"; //31自动撤单
    public static final String SWAP_HISORDERS_V3 = "/linear-swap-api/v3/swap_hisorders"; // 32.获取合约历史委托(新)
    public static final String SWAP_HISORDERS_EXACT_V3 = "/linear-swap-api/v3/swap_hisorders_exact"; // 33.组合查询合约历史委托(新)
    public static final String SWAP_MATCHRESULTS_V3 = "/linear-swap-api/v3/swap_matchresults"; // 34.获取历史成交记录(新)
    public static final String SWAP_MATCHRESULTS_EXACT_V3 = "/linear-swap-api/v3/swap_matchresults_exact"; // 35.组合查询用户历史成交记录(新)
    public static final String SWAP_POSITION_SIDE = "/linear-swap-api/v1/swap_position_side"; // 36.查询持仓模式

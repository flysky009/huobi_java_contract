...
public class HuobiLinearSwapAPIConstants {
    ...
    public static final String BATCH_MERGED_V2 = "/v2/linear-swap-ex/market/detail/batch_merged"; // 批量获取聚合行情（V2）
    ...
    public static final String SWAP_FINANCIAL_RECORD_V3 = "/linear-swap-api/v3/swap_financial_record"; // 查询用户财务记录(新)
    public static final String SWAP_FINANCIAL_RECORD_EXACT_V3 = "/linear-swap-api/v3/swap_financial_record_exact"; // 组合查询用户财务记录 (新)
    ...
    public static final String LINEAR_CANCEL_AFTER = "/linear-swap-api/v1/linear-cancel-after"; //自动撤单
    public static final String SWAP_HISORDERS_V3 = "/linear-swap-api/v3/swap_hisorders"; // 获取合约历史委托(新)
    public static final String SWAP_HISORDERS_EXACT_V3 = "/linear-swap-api/v3/swap_hisorders_exact"; // 组合查询合约历史委托(新)
    public static final String SWAP_MATCHRESULTS_V3 = "/linear-swap-api/v3/swap_matchresults"; // 获取历史成交记录(新)
    public static final String SWAP_MATCHRESULTS_EXACT_V3 = "/linear-swap-api/v3/swap_matchresults_exact"; // 组合查询用户历史成交记录(新)
    public static final String SWAP_POSITION_SIDE = "/linear-swap-api/v1/swap_position_side"; // 查询持仓模式
    ...
    //基础信息接口
    public static final String SWAP_UNIFIED_ACCOUNT_TYPE = "/linear-swap-api/v3/swap_unified_account_type"; // 账户类型查询
    public static final String SWAP_SWITCH_ACCOUNT_TYPE = "/linear-swap-api/v3/swap_switch_account_type"; // 账户类型更改接口
    public static final String SWAP_LIQUIDATION_ORDERS_V3 = "/linear-swap-api/v3/swap_liquidation_orders"; // 获取强平订单(新)
    public static final String SWAP_QUERY_ELEMENTS = "/linear-swap-api/v1/swap_query_elements"; // 合约要素

    //统一账户
    public static final String UNIFIED_ACCOUNT_INFO = "/linear-swap-api/v3/unified_account_info"; // 查询统一账户资产
    public static final String LINEAR_SWAP_OVERVIEW_ACCOUNT_INFO = "/linear-swap-api/v3/linear_swap_overview_account_info"; // 可抵扣HT资产查询
    public static final String LINEAR_SWAP_FEE_SWITCH = "/linear-swap-api/v3/linear_swap_fee_switch"; // 设置U本位合约手续费抵扣方式
    public static final String FIX_POSITION_MARGIN_CHANGE = "/linear-swap-api/v3/fix_position_margin_change"; // 调整逐仓持仓保证金
    public static final String FIX_POSITION_MARGIN_CHANGE_RECORD = "/linear-swap-api/v3/fix_position_margin_change_record"; // 查询调整逐仓持仓保证金记录

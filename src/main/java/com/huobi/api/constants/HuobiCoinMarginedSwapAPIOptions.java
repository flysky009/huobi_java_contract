...
public class HuobiCoinMarginedSwapAPIOptions {
    ...
    public static final String BATCH_MERGED_V2 = "/v2/swap-ex/market/detail/batch_merged"; // 29.批量获取聚合行情（V2）
    public static final String SWAP_LIQUIDATION_ORDERS_V3 = "/swap-api/v3/swap_liquidation_orders"; // 30.获取强平订单(新)
    public static final String SWAP_SETTLEMENT_RECORDS = "/swap-api/v1/swap_settlement_records"; // 31.查询平台历史结算记录
    public static final String SWAP_QUERY_ELEMENTS = "/swap-api/v1/swap_query_elements"; // 32.合约要素
    public static final String TIMESTAMP = "/api/v1/timestamp"; // 33.获取当前系统时间戳
    public static final String HEARTBEAT = "/heartbeat/"; // 34.查询系统是否可用
    public static final String SUMMARY = "https://status-swap.huobigroup.com/api/v2/summary.json"; // 35.获取当前系统状态
    ...
    public static final String SWAP_FINANCIAL_RECORD_V3 = "/swap-api/v3/swap_financial_record"; // 21.查询用户财务记录(新)
    public static final String SWAP_FINANCIAL_RECORD_EXACT_V3 = "/swap-api/v3/swap_financial_record_exact"; // 22.组合查询用户财务记录(新)
    public static final String SWAP_SUB_AUTH_LIST = "/swap-api/v1/swap_sub_auth_list"; // 23.查询子账户交易权限
    ...
    public static final String SWAP_TRIGGER_ORDER = "/swap-api/v1/swap_trigger_order"; // 11.计划委托下单
    public static final String SWAP_TRIGGER_CANCEL = "/swap-api/v1/swap_trigger_cancel";// 12.计划委托撤单
    public static final String SWAP_TRIGGER_CANCELALL = "/swap-api/v1/swap_trigger_cancelall";// 13.计划委托全部撤单
    public static final String SWAP_TRIGGER_OPENORDERS = "/swap-api/v1/swap_trigger_openorders";// 14.获取计划委托当前委托
    public static final String SWAP_TRIGGER_HISORDERS = "/swap-api/v1/swap_trigger_hisorders";// 15.获取计划委托历史委托
    public static final String SWAP_SWITCH_LEVER_RATE = "/swap-api/v1/swap_switch_lever_rate";// 16.切换杠杆
    public static final String SWAP_HISORDERS_EXACT = "/swap-api/v1/swap_hisorders_exact";// 17.获取计划委托历史委托
    public static final String SWAP_MATCHRESULTS_EXACT = "/swap-api/v1/swap_matchresults_exact";// 18.获取计划委托历史委托
    public static final String SWAP_TPSL_ORDER = "/swap-api/v1/swap_tpsl_order";// 19.对仓位设置止盈止损订单
    public static final String SWAP_TPSL_CANCEL = "/swap-api/v1/swap_tpsl_cancel";// 20.止盈止损订单撤单
    public static final String SWAP_TPSL_CANCELALL = "/swap-api/v1/swap_tpsl_cancelall";// 21.止盈止损订单全部撤单
    public static final String SWAP_TPSL_OPENORDERS = "/swap-api/v1/swap_tpsl_openorders";// 22.查询止盈止损订单当前委托
    public static final String SWAP_TPSL_HISORDERS = "/swap-api/v1/swap_tpsl_hisorders";// 23.查询止盈止损订单历史委托
    public static final String SWAP_RELATION_TPSL_ORDER = "/swap-api/v1/swap_relation_tpsl_order";// 24.查询开仓单关联的止盈止损订单详情
    public static final String SWAP_TRACK_ORDER = "/swap-api/v1/swap_track_order"; // 25.跟踪委托订单下单
    public static final String SWAP_TRACK_CANCEL= "/swap-api/v1/swap_track_cancel"; // 26.跟踪委托订单撤单
    public static final String SWAP_TRACK_CANCELALL = "/swap-api/v1/swap_track_cancelall"; // 27.跟踪委托订单全部撤单
    public static final String SWAP_TRACK_OPENORDERS = "/swap-api/v1/swap_track_openorders"; // 28.跟踪委托订单当前委托
    public static final String SWAP_TRACK_HISORDERS = "/swap-api/v1/swap_track_hisorders"; // 29.跟踪委托订单历史委托
    public static final String SWAP_CANCEL_AFTER = "/swap-api/v1/swap-cancel-after"; // 30.自动撤单
    public static final String SWAP_HISORDERS_V3 = "/swap-api/v3/swap_hisorders"; // 31.获取合约历史委托(新)
    public static final String SWAP_HISORDERS_EXACT_V3 = "/swap-api/v3/swap_hisorders_exact"; // 32.组合查询合约历史委托(新)
    public static final String SWAP_MATCHRESULTS_V3 = "/swap-api/v3/swap_matchresults"; // 33.获取历史成交记录（新）
    public static final String SWAP_MATCHRESULTS_EXACT_V3 = "/swap-api/v3/swap_matchresults_exact"; // 34.组合查询用户历史成交记录（新）

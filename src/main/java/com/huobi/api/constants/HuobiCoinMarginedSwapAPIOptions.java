...
public class HuobiCoinMarginedSwapAPIOptions {
    ...
    public static final String BATCH_MERGED_V2 = "/v2/swap-ex/market/detail/batch_merged"; // 批量获取聚合行情（V2）
    public static final String SWAP_LIQUIDATION_ORDERS_V3 = "/swap-api/v3/swap_liquidation_orders"; // 获取强平订单(新)
    public static final String SWAP_SETTLEMENT_RECORDS = "/swap-api/v1/swap_settlement_records"; // 查询平台历史结算记录
    public static final String SWAP_QUERY_ELEMENTS = "/swap-api/v1/swap_query_elements"; // 合约要素
    public static final String TIMESTAMP = "/api/v1/timestamp"; // 获取当前系统时间戳
    public static final String HEARTBEAT = "/heartbeat/"; // 查询系统是否可用
    public static final String SUMMARY = "https://status-swap.huobigroup.com/api/v2/summary.json"; // 获取当前系统状态
    ...
    public static final String SWAP_FINANCIAL_RECORD_V3 = "/swap-api/v3/swap_financial_record"; // 查询用户财务记录(新)
    public static final String SWAP_FINANCIAL_RECORD_EXACT_V3 = "/swap-api/v3/swap_financial_record_exact"; // 组合查询用户财务记录(新)
    ...
    public static final String SWAP_CANCEL_AFTER = "/swap-api/v1/swap-cancel-after"; // 自动撤单
    public static final String SWAP_HISORDERS_V3 = "/swap-api/v3/swap_hisorders"; // 获取合约历史委托(新)
    public static final String SWAP_HISORDERS_EXACT_V3 = "/swap-api/v3/swap_hisorders_exact"; // 组合查询合约历史委托(新)
    public static final String SWAP_MATCHRESULTS_V3 = "/swap-api/v3/swap_matchresults"; // 获取历史成交记录（新）
    public static final String SWAP_MATCHRESULTS_EXACT_V3 = "/swap-api/v3/swap_matchresults_exact"; // 组合查询用户历史成交记录（新）

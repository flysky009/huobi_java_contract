...
public class HuobiFutureAPIConstants {
    ...
    public static final String BATCH_MERGED_V2 = "/v2/market/detail/batch_merged"; // 27.批量获取聚合行情（V2）
    public static final String CONTRACT_LIQUIDATION_ORDERS_V3  = "/api/v3/contract_liquidation_orders"; // 28.获取强平订单(新)
    public static final String CONTRACT_QUERY_ELEMENTS = "/api/v1/contract_query_elements"; // 29.合约要素
    ...
    public static final String CONTRACT_FINANCIAL_RECORD_V3 = "/api/v3/contract_financial_record"; // 21.查询用户财务记录(新)
    public static final String CONTRACT_FINANCIAL_RECORD_EXACT_V3 = "/api/v3/contract_financial_record_exact"; // 22.组合查询用户财务记录(新)
    public static final String CONTRACT_SUB_AUTH_LIST = "/api/v1/contract_sub_auth_list"; // 23.查询子账户交易权限
    ...
    public static final String CONTRACT_TRACK_ORDER = "/api/v1/contract_track_order"; // 25.跟踪委托订单下单
    public static final String CONTRACT_TRACK_CANCEL= "/api/v1/contract_track_cancel"; // 26.跟踪委托订单撤单
    public static final String CONTRACT_TRACK_CANCELALL = "/api/v1/contract_track_cancelall"; // 27.跟踪委托订单全部撤单
    public static final String CONTRACT_TRACK_OPENORDERS = "/api/v1/contract_track_openorders"; // 28.跟踪委托订单当前委托
    public static final String CONTRACT_TRACK_HISORDERS = "/api/v1/contract_track_hisorders"; // 29.跟踪委托订单历史委托
    public static final String CONTRACT_CANCEL_AFTER = "/api/v1/contract-cancel-after"; // 30.自动撤单
    public static final String CONTRACT_HISORDERS_V3 = "/api/v3/contract_hisorders"; // 31.获取合约历史委托(新)
    public static final String CONTRACT_HISORDERS_EXACT_V3 = "/api/v3/contract_hisorders_exact"; // 32.组合查询合约历史委托(新)
    public static final String CONTRACT_MATCHRESULTS_V3 = "/api/v3/contract_matchresults"; // 33.获取历史成交记录(新)
    public static final String CONTRACT_MATCHRESULTS_EXACT_V3 = "/api/v3/contract_matchresults_exact"; // 34.组合查询历史成交记录接口(新)

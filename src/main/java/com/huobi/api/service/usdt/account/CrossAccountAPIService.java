...
public interface CrossAccountAPIService {
    ...
    SwapCrossSubAccountListResponse getSwapCrossSubAccountList(String marginAccount, String direct, Long fromId, String tradePartition);//查询母账户下所有子账户资产信息（全仓模式）
    ...
    SwapCrossAvailableLevelRateResponse getSwapCrossAvailableLevelRate(String contractCode, String pair, String contractType, String businessType, String tradePartition);//查询当前可能杠杆倍数（全仓模式）

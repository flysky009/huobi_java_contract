...
public interface CrossTradeAPIService {
    ...
    SwapCrossHisordersExactV3Response swapCrossHisordersExactV3Response(SwapCrossHisordersExactV3Request request);

    SwapCrossHisordersV3Response swapCrossHisordersV3Response(SwapCrossHisordersV3Request request);

    SwapCrossMatchResultsV3Response swapCrossMatchResultsV3Response(SwapCrossMatchResultsV3Request request);

    SwapCrossMatchResultsExactV3Response swapCrossMatchResultsExactV3Response(SwapCrossMatchResultsExactV3Request request);

    SwapCrossPositionSideResponse swapCrossPositionSideResponse(String marginAccount);
}

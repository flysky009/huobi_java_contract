...
public interface ReferenceAPIService {
    ...
    public SwapBatchFundingRateResponse getSwapBatchFundingRate(String contractCode, String tradePartition);// 2.批量获取合约资金费率
    ...
    public SwapApiStateResponse getSwapApiState(String contractCode,String tradePartition);// 8.查询系统状态

    public SwapLadderMarginResponse getSwapLadderMargin(String contractCode,String tradePartition);// 9.获取平台阶梯保证金

    public SwapEstimatedSettlementPriceResponse getSwapEstimatedSettlementPrice(String contractCode,String pair,String contractType,String businessType,String tradePartition);// 10.获取预估结算价

    public SwapAdjustfactorResponse getSwapAdjustfactor(String contractCode,String tradePartition);// 11.查询平台阶梯调整系数
    ...
    public SwapRiskInfoResponse getSwapRiskInfo(String contractCode,String businessType,String tradePartition);// 13.查询合约风险准备金和预估分摊比例

    public SwapPriceLimitResponse getSwapPriceLimit(String contractCode, String pair, String contractType, String businessType, String tradePartition);// 14.获取合约最高限价和最低限价

    public SwapOpenInterestResponse getSwapOpenInterest(String contractCode, String pair, String contractType, String businessType, String tradePartition);// 15.获取当前可用合约总持仓量

    public SwapContractInfoResponse getSwapContractInfo(String contractCode, String supportMarginMode, String pair, String contractType, String businessType, String tradePartition);// 16.获取合约信息

    public SwapIndexResponse getSwapIndex(String contractCode, String tradePartition);// 17.获取合约指数信息

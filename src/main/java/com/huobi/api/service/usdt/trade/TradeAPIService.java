...
public interface TradeAPIService {
    ...
    LinearCancelAfterResponse linearCancelAfterResponse(LinearCancelAfterRequest request);
    ...
    SwapPositionSideResponse swapPositionSideResponse(SwapPositionSideRequest request);
}

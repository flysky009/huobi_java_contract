...
public interface TradeAPIService {
    ...
    ContractCancelAfterResponse contractCancelAfterResponse(ContractCancelAfterRequest request);

    ContractHisordersV3Response contractHisordersV3Response(ContractHisordersV3Request request);

    ContractHisordersExactV3Response contractHisordersExactV3Response(ContractHisordersExactV3Request request);

    ContractMatchResultsV3Response contractMatchResultsV3Response(ContractMatchResultsV3Request request);

    ContractMatchResultsExactV3Response contractMatchResultsExactV3Response(ContractMatchResultsExactV3Request request);
}
